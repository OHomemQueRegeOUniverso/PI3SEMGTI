<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_dashboard.aspx.cs" Inherits="pages_Administrador_Admin_dashboard" %>
                ...
                <div class="col-md-3 left_col">
                    <div class="left_col scroll-view">
                        <div class="navbar nav_title" style="border: 0;">
                            <a href="index.html" class="site_title"><i class="fa fa-refresh fa-spin"></i><span>Paturi System</span></a>
                        </div>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            ...
                            <ul class="dropdown-menu dropdown-usermenu pull-right">
                                ...
                                <li><a href="loginscreen.aspx"><i class="fa fa-sign-out pull-right"></i>Log Out</a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
