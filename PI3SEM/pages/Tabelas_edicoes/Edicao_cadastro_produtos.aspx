<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Edicao_cadastro_produtos.aspx.cs" Inherits="pages_Tabelas_edicoes_Edicao_cadastro" %>
...
<body class="nav-md" style="overflow-x: hidden">
        ...
        <asp:UpdatePanel runat="server">
            <ContentTemplate>
                <div id="DIVALTERAR" style="margin-left: 400px; display: inline-block !important;">
                    <asp:TextBox ID="modelo" runat="server" Text="Nome"></asp:TextBox>
                    <asp:TextBox ID="Quantidade" runat="server" Text="Quantidade"></asp:TextBox>
                    <asp:Label ID="msgalterarprod" runat="server"></asp:Label>
                    <asp:Button ID="Button2" runat="server" class="btn btn-default" Text="Alterar" OnClick="Button2_Click"  />
                </div>
                <!--FINAL -->
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:LinkButton ID="lbAlterar" runat="server" CommandName="Alterar"
                                    CommandArgument='<%#Bind("prod_codigo")%>'>Alterar</asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:LinkButton ID="LbDeletar" runat="server" CommandName="Deletar" CssClass="danger"
                                    CommandArgument='<%#Bind("prod_codigo")%>'>Excluir</asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
