<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Edicao_pedido.aspx.cs" Inherits="pages_Tabelas_edicoes_Edicao_pedido" %>
...
<body class="nav-md" style="overflow-x: hidden">
                    ...
                    <asp:UpdatePanel runat="server">
                        <ContentTemplate>
                            <div class="col-md-12 col-sm-6 col-xs-12 form-group ">
                                <asp:TextBox ID="txt_ped_datahora" runat="server" class="form-control" Text="Data/Hora EX: 13/02/2005 23:30"></asp:TextBox>
                            </div>
                            <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                <asp:DropDownList ID="dropstatus" runat="server" Style="width: 190px; height: 33px;">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12 form-group ">
                                <asp:DropDownList ID="dropcliente" runat="server" Style="width: 190px; height: 33px;"></asp:DropDownList>
                            </div>
                            <div class="col-md-4 col-sm-6 col-xs-12 form-group ">
                                <asp:DropDownList ID="dropproduto" runat="server" Style="width: 190px; height: 33px;">
                                    
                                </asp:DropDownList>
                            </div>
                            <div class="col-md-12 col-sm-6 col-xs-12 form-group ">
                                <asp:TextBox ID="txt_ped_quantidade" runat="server" class="form-control" Text="QUANTIDADE"></asp:TextBox>
                            </div>
                            <asp:Label ID="msg" runat="server" Style="margin-left: 11px; background-color: mediumspringgreen;"></asp:Label>
                            <asp:Button ID="Button1" class="btn btn-default" Style="width: 100px; margin-left: 520px;" runat="server" Text="Alterar" OnClick="Button1_Click" />
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
        </div>
        ...
        <asp:GridView ID="GridView1" runat="server" OnRowCommand="GridView1_RowCommand" Style="display:inline-block !important; margin-left: 400px; margin-top: 40px; width: auto;" CssClass="table table-striped table-bordered table-condensed">
         <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:LinkButton ID="lbAlterar" runat="server" CommandName="Alterar"
                                    CommandArgument='<%#Bind("ped_codigo")%>'>Alterar</asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:LinkButton ID="LbCancelar" runat="server" CommandName="Cancelar" CssClass="danger"
                                    CommandArgument='<%#Bind("ped_codigo")%>'>Cancelar</asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>           
                </asp:GridView>
