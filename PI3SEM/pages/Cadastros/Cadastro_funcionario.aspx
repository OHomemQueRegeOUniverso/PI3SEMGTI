<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cadastro_funcionario.aspx.cs" Inherits="pages_Cadastros_Cadastro_funcionario" %>
...
<body class="nav-md" style="overflow-x: hidden">
        ...
        <div class="col-md-6 col-xs-12">
            <div class="x_panel" id="div1">
                <div class="x_title">
                    <h2>Cerâmicas Paturi <small>Cadastro de funcionario</small></h2>
                    <a style="margin-left: 120px;"><i class="fa fa-close"></i></a>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <br />
                    ...
                    <asp:UpdatePanel runat="server">
                        <ContentTemplate>
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group ">
                                <asp:TextBox ID="txt_fun_nome" runat="server" class="form-control" required="" placeholder="Nome "></asp:TextBox>
                            </div>

                             <div class="col-md-6 col-sm-6 col-xs-12 form-group ">
                                <asp:TextBox ID="txt_fun_setor" runat="server" class="form-control" required="" placeholder="Setor de trabalho "></asp:TextBox>
                            </div>

                            <div class="col-md-6 col-sm-6 col-xs-12 form-group ">
                                <asp:TextBox ID="txt_fun_cargo" runat="server" class="form-control" required="" placeholder="Cargo"></asp:TextBox>
                            </div>

                             <div class="col-md-6 col-sm-6 col-xs-12 form-group ">
                                <asp:TextBox ID="txt_fun_documento" runat="server" class="form-control" required="" placeholder="Documento"></asp:TextBox>
                            </div>

                            <div class="col-md-6 col-sm-6 col-xs-12 form-group ">
                                <asp:TextBox ID="txt_fun_sexo" runat="server" class="form-control" required="" placeholder="Sexo"></asp:TextBox>
                            </div>

                            <div class="col-md-6 col-sm-6 col-xs-12 form-group ">
                                <asp:TextBox ID="txt_fun_telefone" runat="server" class="form-control" required="" placeholder="Telefone (Somente números)"></asp:TextBox>
                            </div>

                            <div class="col-md-6 col-sm-6 col-xs-12 form-group ">
                                <asp:TextBox ID="txt_fun_cidade" runat="server" class="form-control" required="" placeholder="Cidade"></asp:TextBox>
                            </div>


                            <div class="col-md-6 col-sm-6 col-xs-12 form-group ">
                                <asp:TextBox ID="txt_fun_endereco" runat="server" class="form-control" required="" placeholder="Endereço"></asp:TextBox>
                            </div>

                            <div class="col-md-6 col-sm-6 col-xs-12 form-group ">
                                <asp:TextBox ID="txt_fun_email" runat="server" class="form-control" Type="email" required="" placeholder="Email"></asp:TextBox>
                            </div>

                            <div class="col-md-6 col-sm-6 col-xs-12 form-group ">
                                <asp:TextBox ID="txt_fun_cep" runat="server" class="form-control" required="" placeholder="CEP"></asp:TextBox>
                            </div>

                            
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group ">
                                <asp:TextBox ID="txt_fun_senha" runat="server" class="form-control" type="password" required="" placeholder="Insira a senha de acesso"></asp:TextBox>
                            </div>
