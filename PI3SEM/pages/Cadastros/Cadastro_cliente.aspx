<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cadastro_cliente.aspx.cs" Inherits="pages_Cadastros_Cadastro_cliente" %>
...
<body class="nav-md" style="overflow-x: hidden">
        ...
        <div class="col-md-6 col-xs-12">
            <div class="x_panel" id="div1">
                <div class="x_title">
                    <h2>Cerâmicas Paturi <small>cadastro de Cliente</small></h2>
                    ...
                    <asp:UpdatePanel runat="server">
                        <ContentTemplate>
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group ">
                                <asp:TextBox ID="txt_cli_cnpj" runat="server" class="form-control" required="" placeholder="CNPJ (Somente os números) "></asp:TextBox>
                            </div>

                            <div class="col-md-6 col-sm-6 col-xs-12 form-group ">
                                <asp:TextBox ID="txt_cli_nome" runat="server" class="form-control" required="" placeholder="Nome"></asp:TextBox>
                            </div>

                            <div class="col-md-6 col-sm-6 col-xs-12 form-group ">
                                <asp:TextBox ID="txt_cli_telefone" runat="server" class="form-control" required="" placeholder="Telefone (somente os números)"></asp:TextBox>
                            </div>

                            <div class="col-md-6 col-sm-6 col-xs-12 form-group ">
                                <asp:TextBox ID="txt_cli_cidade" runat="server" class="form-control" required="" placeholder="Cidade"></asp:TextBox>
                            </div>

                            <div class="col-md-6 col-sm-6 col-xs-12 form-group ">
                                <asp:TextBox ID="txt_cli_endereco" runat="server" class="form-control" required="" placeholder="Endereço"></asp:TextBox>
                            </div>

                            <div class="col-md-6 col-sm-6 col-xs-12 form-group ">
                                <asp:TextBox ID="txt_cli_email" runat="server" class="form-control" Type="email" required="" placeholder="Email"></asp:TextBox>
                            </div>

                            <div class="col-md-6 col-sm-6 col-xs-12 form-group ">
                                <asp:TextBox ID="txt_cli_cep" runat="server" class="form-control" required="" placeholder="CEP"></asp:TextBox>
                            </div>
