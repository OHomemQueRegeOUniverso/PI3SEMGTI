<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cadastro_materiaprima.aspx.cs" Inherits="pages_Cadastros_Cadastro_materiaprima" %>
       ...
       <form runat="server">
        ...
        <div class="col-md-6 col-xs-12">
            <div class="x_panel" id="div1">
                <div class="x_title">
                    <h2>Cerâmicas Paturi <small>cadastro de Materia prima</small></h2>
                    ...
                    <asp:UpdatePanel runat="server">
                        <ContentTemplate>
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group ">
                                <asp:TextBox ID="txt_matprim_nome" runat="server" class="form-control" required="" placeholder="Nome"></asp:TextBox>
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                                <asp:TextBox ID="txt_matprim_quantidade" runat="server" class="form-control" required="" placeholder="Quantidade"></asp:TextBox>
                            </div>
