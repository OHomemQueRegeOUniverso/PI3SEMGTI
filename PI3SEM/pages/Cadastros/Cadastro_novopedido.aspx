<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cadastro_novopedido.aspx.cs" Inherits="pages_Cadastros_Cadastro_perdas" %>
       ...
       <form runat="server">
        ...
        <div class="col-md-6 col-xs-12">
            <div class="x_panel" id="div1">
                <div class="x_title">
                    <h2>Cerâmicas Paturi <small>cadastro de novo pedido</small></h2>
                    ...
                    <asp:UpdatePanel runat="server">
                        <ContentTemplate>
                            <div class="col-md-12 col-sm-6 col-xs-12 form-group ">
                                <asp:TextBox ID="txt_ped_datahora" runat="server" class="form-control" required="" placeholder="Data/Hora EX: 13/02/2005 23:30"></asp:TextBox>
                            </div>
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12 form-group ">
                                <asp:DropDownList ID="dropcliente" runat="server" required="" Style="width: 190px; height: 33px;"></asp:DropDownList>
                            </div>
                            <div class="col-md-4 col-sm-6 col-xs-12 form-group ">
                                <asp:DropDownList ID="dropproduto" runat="server" required="" Style="width: 190px; height: 33px;"></asp:DropDownList>
                            </div>
                            <div class="col-md-12 col-sm-6 col-xs-12 form-group ">
                                <asp:TextBox ID="txt_ped_quantidade" runat="server" class="form-control" required="" placeholder="Quantidade"></asp:TextBox>
                            </div>
