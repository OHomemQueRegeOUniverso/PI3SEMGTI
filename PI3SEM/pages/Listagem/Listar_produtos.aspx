<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listar_produtos.aspx.cs" Inherits="pages_Listagem_Listar_produtos" %>
...
<body class="nav-md" style="overflow-x: hidden">
        ...
        <asp:UpdatePanel runat="server">
            <ContentTemplate>
                ...
                <asp:GridView ID="GridView1" runat="server" Style="display:inline-block !important; margin-left: 400px; margin-top: 40px; width: auto;" CssClass="table table-striped table-bordered table-condensed">
                </asp:GridView>
            </ContentTemplate>
        </asp:UpdatePanel>
